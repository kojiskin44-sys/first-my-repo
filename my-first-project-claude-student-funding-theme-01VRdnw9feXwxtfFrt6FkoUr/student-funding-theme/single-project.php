            ...
            <div class="project-layout">
                ...
                <div class="project-main">
                    ...
                    <div class="supporters-section">
                        <h2>支援者の皆さま（<?php echo number_format($supporter_count); ?>人）</h2>
                        <?php
                        $supporters = student_funding_get_supporters(get_the_ID());
                        if ($supporters) :
                            ?>
                                ...
                                <?php foreach ($supporters as $supporter) : ?>
                                    <li class="supporter-item">
                                        <span class="supporter-name">
                                            <?php echo $supporter->is_anonymous ? '匿名' : esc_html($supporter->supporter_name); ?>
                                        </span>
                                        <span class="supporter-amount">
                                            <?php echo student_funding_format_amount($supporter->support_amount); ?>
                                        </span>
                                        <span class="supporter-date">
                                            <?php echo date('Y/m/d', strtotime($supporter->support_date)); ?>
                                        </span>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else : ?>
                            <p class="no-supporters">まだ支援者がいません。最初の支援者になりませんか？</p>
                        <?php endif; ?>
                    </div>
                </div><!-- .project-main -->
